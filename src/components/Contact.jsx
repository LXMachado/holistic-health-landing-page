...
const Contact = () => {
  ...
  return (
    <motion.section
      ...
      <motion.div variants={fadeIn("up", "tween", 0.2, 1)} className="container mx-auto px-6 py-10 flex justify-center">
          ...
          <div className="lg:flex lg:items-center">
            <div className="lg:w-1/2 lg:pr-8">
              <div className="mt-6 space-y-8 md:mt-8">
                ...
                <p className="-mx-2 flex items-start">
                  ...
                  <a href="tel:+61406757655" className="mx-2 w-72 truncate font-urbanist text-base-content hover:underline">
                    +61 406 757 655
                  </a>
                </p>
                <p className="-mx-2 flex items-start">
                  ...
                  <a href="mailto:info@beyondbodyholistichealth.com.au" className="mx-2 w-72 truncate font-urbanist text-base-content hover:underline">
            ...
            <div className="mt-6 w-80 md:mt-8">
              ...
              <div className="-mx-1.5 mt-4 flex ">
                <a
                  ...
                  href="https://www.facebook.com/profile.php?id=61564636092880"
                  aria-label="facebook">
                  <svg
                    className="h-8 w-8"
                    viewBox="0 0 24 24"
            ...
            <div className="lg:w-1/2">
              <div className="mt-8 w-full">
                <div className="card w-full overflow-hidden rounded-lg px-8 py-10 shadow-xl outline outline-base-content/5">
